        ...
        <div class="app-auth-container">
            ...
            <div class="alert alert-custom" role="alert">
                ...
                <div class="alert-content">
                    <span class="alert-title"><?php echo $_SESSION['successfully'];?></span>
                </div>
            </div>
            ...
            <div class="alert alert-custom" role="alert">
                ...
                <div class="alert-content">
                    <span class="alert-title"><?php echo $_SESSION['login_error'];?></span>
                </div>
            </div>
            ...
            <div class="auth-credentials m-b-xxl">
                ...
                <input name="email" type="email" class="form-control m-b-md" id="signInEmail" aria-describedby="signInEmail" placeholder="example@neptune.com" value="<?php if(isset($_SESSION['register_email'])){echo $_SESSION['register_email'];}unset($_SESSION['register_email'])?>">
                ...
                <input name="password" type="password" class="form-control" id="signInPassword" aria-describedby="signInPassword" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" value="<?php if(isset($_SESSION['register_password'])){echo $_SESSION['register_password'];}unset($_SESSION['register_password'])?>">
